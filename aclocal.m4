...
m4_include([build-aux/ax_cxx_compile_stdcxx_11.m4])
...
m4_include([build-aux/manywarnings.m4])
m4_include([build-aux/perl.m4])
m4_include([build-aux/util.m4])
m4_include([build-aux/warnings.m4])
