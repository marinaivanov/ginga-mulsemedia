...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/doc/doc.mk \
	$(top_srcdir)/build-aux/Makefile.am.common \
	$(top_srcdir)/build-aux/Makefile.am.coverage \
	...
	$(top_srcdir)/build-aux/perl.m4 \
	$(top_srcdir)/build-aux/warnings.m4 AUTHORS COPYING ChangeLog \
...
ACLOCAL = ${SHELL} /home/eyre/Desktop/ginga-mulsemedia/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/eyre/Desktop/ginga-mulsemedia/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/eyre/Desktop/ginga-mulsemedia/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/eyre/Desktop/ginga-mulsemedia/build-aux/missing automake-1.15
AWK = mawk
...
GINGA_VERSION_MICRO = 12
GINGA_VERSION_MINOR = 0
GINGA_VERSION_STRING = 1.0.12-0f6c-dirty
...
LUA_VERSION = 5.2
M4 = m4
MAKEINFO = ${SHELL} /home/eyre/Desktop/ginga-mulsemedia/build-aux/missing makeinfo
MANIFEST_TOOL = :
MINGW_ROOT = 
MKDIR_P = /bin/mkdir -p
NCLUA_CFLAGS = 
...
PACKAGE_NAME = Ginga
PACKAGE_STRING = Ginga 1.0.12-0f6c-dirty
PACKAGE_TARNAME = ginga
PACKAGE_URL = http://github.com/TeleMidia/ginga
PACKAGE_VERSION = 1.0.12-0f6c-dirty
...
STRIP = strip
VALGRIND = 
VERSION = 1.0.12-0f6c-dirty
WARN_CFLAGS = 
WERROR_CFLAGS = 
WINDRES = 
abs_builddir = /home/eyre/Desktop/ginga-mulsemedia
abs_srcdir = /home/eyre/Desktop/ginga-mulsemedia
abs_top_builddir = /home/eyre/Desktop/ginga-mulsemedia
abs_top_srcdir = /home/eyre/Desktop/ginga-mulsemedia
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/eyre/Desktop/ginga-mulsemedia/build-aux/install-sh
...
top_srcdir = .
CLEANDIRS = doc/html
CLEANFILES = *.core *.gcda *.gcno vgcore.* doc/Doxyfile \
	$(am__append_1)
DISTCLEANFILES = 
EXTRA_DIST = doc/Doxyfile.in doc/arch.png doc/arch.tex $(am__append_2)
MAINTAINERCLEANFILES = Makefile.in INSTALL ChangeLog Makefile.in \
	aclocal.m4 build-aux/ar-lib build-aux/compile \
	build-aux/config.guess build-aux/config.sub build-aux/depcomp \
	build-aux/install-sh build-aux/libtool.m4 build-aux/ltmain.sh \
	build-aux/ltoptions.m4 build-aux/ltsugar.m4 \
	build-aux/ltversion.m4 build-aux/lt~obsolete.m4 \
	build-aux/missing build-aux/test-driver configure $(NULL)
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/build-aux/Makefile.am.common $(top_srcdir)/build-aux/Makefile.am.coverage $(srcdir)/doc/doc.mk $(am__configure_deps)
	@for dep in $?; do \
...
$(top_srcdir)/build-aux/Makefile.am.common $(top_srcdir)/build-aux/Makefile.am.coverage $(srcdir)/doc/doc.mk $(am__empty):
